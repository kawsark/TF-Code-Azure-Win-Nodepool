...
resource "azurerm_kubernetes_cluster" "aks_cluster" {
  ...
  # Windows Profile
  windows_profile {
    admin_username = var.windows_admin_username # Should be obtained from Vault secrets management
    admin_password = var.windows_admin_password # Should be obtained from Vault secrets management
  }
